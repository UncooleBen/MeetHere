...
<div class="container">
      <form name="myForm" class="form-signin" action="login" method="post" onsubmit="return checkForm()">
        ...
        <input id="username" name="username" value="${user._username }" type="text" class="input-block-level" placeholder="账号">
        <input id="password" name="password" value="${user._password }" type="password" class="input-block-level" placeholder="密码" >
